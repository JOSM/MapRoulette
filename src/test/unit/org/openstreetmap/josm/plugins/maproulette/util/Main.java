 ...
 * TODO Put this in JOSM core
 */
@Target({ElementType.TYPE, ElementType.METHOD})
@Retention(RetentionPolicy.RUNTIME)
@HTTP
@LayerManager
@ExtendWith(Main.Extension.class)
public @interface Main {
    ...
    class Extension implements BeforeEachCallback {
         ...
         */
        public Extension setMapViewMocker(Runnable mapViewStateMockingRunnable) {
         ...
         * @return this, for easy chaining
         */
        public Extension setNavigableComponentMocker(Runnable navigableComponentMockingRunnable) {
